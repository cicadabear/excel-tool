 ...
 * 利用开源组件POI导出EXCEL文档
 */
public class ExportExcelXUtils<T> {
    protected static Logger logger = LoggerFactory.getLogger(ExportExcelXUtils.class);
    ...
    public SXSSFWorkbook exportExcelXWithCommonData(String title, String[] headers, String[] footers, List<List<String>> dataList, boolean createTitle, Integer createTotal) {
        ...
        exportExcelXWithCommonDataCreateSheet(workbook, title, title, headers, footers, dataList, createTitle, createTotal);
        return workbook;
    }

    public void exportExcelXWithCommonDataCreateSheet(SXSSFWorkbook workbook, String title, String sheetName, List<String> headers, String[] footers, List<List<String>> dataList, boolean createTitle, Integer createTotal) {
        exportExcelXWithCommonDataCreateSheet(workbook, title, sheetName, headers.stream().toArray(String[]::new), footers, dataList, createTitle, createTotal);
    }

    public void exportExcelXWithCommonDataCreateSheet(SXSSFWorkbook workbook, String title, String sheetName, String[] headers, String[] footers, List<List<String>> dataList, boolean createTitle, Integer createTotal) {
        // 生成一个表格
